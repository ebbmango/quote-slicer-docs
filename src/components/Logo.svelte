...
<a
	href={resolve('/')}
	class="opacity-transition flex h-min items-center gap-2 opacity-70 hover:opacity-80"
>
	<svg class="size-13" xmlns="http://www.w3.org/2000/svg" viewBox="96 96 448 448"
		><path
