...
<a
	href={resolve('/')}
	class="logo focus-ring-none group opacity-transition flex h-min items-center gap-2 opacity-70 hocus:opacity-80"
>
	<svg class="logo-mark fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="96 96 448 448"
		><path
