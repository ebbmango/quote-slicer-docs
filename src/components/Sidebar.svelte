...
<div
	class="flex h-dvh min-w-70 flex-col items-center justify-between overflow-hidden border-0 border-r border-gray-200 px-8 dark:border-[#404040] dark:bg-umbra dark:text-gray-300"
>
	<!-- Logo -->
